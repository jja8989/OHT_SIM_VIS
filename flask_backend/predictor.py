...
class Predictor:
    def __init__(self, ckpt_full_path: str, meta_pt_path: str, layout_json_path: str, device: str = None):
        ...
        state_dict = meta.pop("model_state")   # 모델 가중치 따로 꺼내기
    ...
    def step_and_predict_bin(self, avg_speed_arr, count_bin_arr):
        ...
        with torch.no_grad():
            yp_z = self.model(Xseq, self.A_powers).squeeze(0)  # (H,E)
        ...
        # print(f"[Predictor] step_and_predict_bin took {elapsed*1000:.2f} ms")
        return out
